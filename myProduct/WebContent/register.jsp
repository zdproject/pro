			...
			xhr.onreadystatechange=function(){
				if( xhr.readyState==4 && xhr.status==200 ){	//请求和服务器响应正常
					...
					if("yes"==xhr.responseText){
						emailMessage.innerHTML = "<span style='color:green'>该邮箱可以使用</span>";
					}else{
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<input type="text" class="textinput"
									name="email" onblur="searchEmail(this.value)" /></td>
								<td><span id="emailMessage" style="color:#999999">请输入合法的邮箱</span></td>
							</tr>
							<tr>
