...
<script type="text/javascript" src="js/modeifyuserinfo.js">
	
</script>
</head>

<body class="main" onload="startModi()">
				...
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							...
							<td style="padding-top:30px"><font
								...
								<a href="${pageContext.request.contextPath }/login.jsp"><span id="modi">5</span>秒后自动为您转跳回登录页面</a></td>
						</tr>
					</table>
					<h1>&nbsp;</h1></td>
			</tr>
